...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Rakefile", "README.rdoc", "lib/rack", "lib/rack/test", "lib/rack/test/cookie_jar.rb", "lib/rack/test/methods.rb", "lib/rack/test/utils.rb", "lib/rack/test.rb", "MIT-LICENSE.txt"]
  s.has_rdoc = true
