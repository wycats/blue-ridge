...
function derive_spec_name_from_current_file() {
  // RSI: removed $ at the end of regex as otherwise focused tests were not run
  var file_prefix = new String(window.location).match(/.*\/(.*?)\.html/)[1];
  return file_prefix + "_spec.js";
}

require("../../vendor/plugins/javascript_testing/lib/jquery-1.3.2.js", {onload: function() {
// require("../../vendor/plugins/javascript_testing/lib/jquery-1.2.6.js", {onload: function() {
  jQuery.noConflict();
}});
...
// RSI: added screw.mocks
require("../../vendor/plugins/javascript_testing/lib/screw.mocks.js");
